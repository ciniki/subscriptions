...
function ciniki_subscriptions_getHistory($ciniki) {
	...
	return ciniki_core_dbGetModuleHistory($ciniki, 'subscriptions', 'ciniki_subscription_history', $args['business_id'], 'ciniki_subscriptions', $args['subscriptions_id'], $args['field']);
}
?>
