...
function ciniki_subscriptions_settingsUpdate(&$ciniki) {
    ...
    $rc = ciniki_subscriptions_checkAccess($ciniki, $args['tnid'], 'ciniki.subscriptions.settingsUpdate'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    foreach($changelog_fields as $field) {
        if( isset($ciniki['request']['args'][$field]) ) {
            $strsql = "INSERT INTO ciniki_subscriptions_settings (tnid, detail_key, detail_value, date_added, last_updated) "
